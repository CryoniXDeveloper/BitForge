...
struct CPU {
    ...
    std::unordered_map<int,int> mnemonicMoveOperand1Bytes = {
        ...
        {0x14,2},{0x15,2},{0x16,2},{0x17,2},{0x18,2},
        {0x19,2},{0x1A,2},{0x1B,2},{0x1C,2},{0x1D,2},
        {0x1E,4},{0x1F,4},{0x20,4},{0x21,4},{0x22,4},
        {0x23,4},{0x24,4},{0x25,4},{0x26,4},{0x27,4},
        {0x28,8},{0x29,8},{0x2A,8},{0x2B,8},{0x2C,8},
        {0x2D,8},{0x2E,8},{0x2F,8},{0x30,8},{0x31,8},
        {0x32,1},{0x33,1},{0x34,1},{0x35,1},{0x36,1},
        {0x37,1},{0x38,1},{0x39,1},{0x3A,1},{0x3B,1},
    ...
    std::unordered_map<int,std::string> mnemonicMoveOperand1Types = {
        {0x00,"r"},{0x01,"r"},{0x02,"r"},{0x03,"r"},{0x04,"r"},
        {0x05,"r"},{0x06,"r"},{0x07,"r"},{0x08,"r"},{0x09,"r"},
        {0x0A,"mi"},{0x0B,"mi"},{0x0C,"mi"},{0x0D,"mi"},{0x0E,"mi"},
        {0x0F,"mi"},{0x10,"mi"},{0x11,"mi"},{0x12,"mi"},{0x13,"mi"},
